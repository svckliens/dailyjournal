...
<!-- content end -->
    <!-- footer begin -->
    <footer class="text-center p-2 bg-danger-subtle footer fixed-bottom">
    <div>
        <a href="https://www.instagram.com/rendystywn_"
        ><i class="bi bi-instagram h2 p-2 text-dark"></i
        ></a>
        <a href="https://twitter.com/udinusofficial"
        ><i class="bi bi-twitter h2 p-2 text-dark"></i
        ></a>
        <a href="https://wa.me/+6287832051990"
        ><i class="bi bi-whatsapp h2 p-2 text-dark"></i
        ></a>
    </div>
    <div>Rendy Setyawan &copy; 2024</div>
    </footer>
    <!-- footer end -->
    <script
